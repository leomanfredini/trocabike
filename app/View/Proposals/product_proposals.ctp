...
<div class="forms">
	...
	<fieldset>
		<h2>Propostas Recebidas<span></span></h2>
		<div class="forms-content">
			<div align="center">
				<?php 
					if ($proposals[0]['Product']['title'] == null){
						echo '<br><h1>Produto sem propostas até o momento</h1><br>';
					} else {
						echo '<h1>Produto: <font color="green">' . $proposals[0]['Product']['title']. '</font></h1><br>'; ?>
						<table class="tg">
						  <tr>
		...
		<?php //debug ($proposals[0]['Product']['title']); ?>
